					...
					<section id="tab_cont1_01" role="tabpanel" aria-labelledby="option1_01" class="tab_panel active">
						<div class="bbs_list Thumbnail"> 
							<ul class="defulat">
								...
								<li>
									<!-- 이미지가 없을경우 공란으로 처리, 이미지가 있는경우 play 클래스 추가 -->
									<a href="#none" class="ThumbnailArea" title="게시물 제목"></a>
									<div class="infoArea">
										<span class="cag">공통·일반</span>
										<a href="#none" class="noticeTitle">
											<p>2022학년도 하계방학 중 국가근로장2022학년도 하계방학 중 국가근로장2022학년도 하계방학 중 국가근로장</p>
								...
								<li>
									...
									<div class="infoArea">
										<span class="cag">공통·일반</span>
										<a href="#none" class="noticeTitle">
											<p>2022학년도 하계방학 중 국가근로장하계방학 중 국가근로장하계방학 중 국가근로장하계방학 중 국가근로장하계방학 중 국가근로장</p>
											<i class="ripple" style="display:none">[9999]</i>
											<i class="iconB PIN"><span class="hidden">비밀글</span></i>
											<i class="iconB new"><span class="hidden">새글</span></i>
										</a>
